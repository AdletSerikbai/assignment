public class CinemaManagementApp {
    public static void main(String[] args) {
        ...
        TicketBooking booking = new TicketBooking.TicketBookingBuilder()
                ...
                .build();
        System.out.println("Booking: Movie - " + booking.getMovieTitle() + ", Seat - " + booking.getSeatNumber());
        ...
        System.out.println("Movie Schedule for " + movie.getTitle() + " at " + template.getTime());
    }
}